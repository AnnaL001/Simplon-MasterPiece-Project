        ...
        <div class="col-12 col-md-8">
            <div class="card shadow">
                <div class="card-body px-5 py-4">
                    ...
                    <?= Html::a(Yii::t('app', 'Update profile'), ['/donor-profile/update', 'id' => $model->donor_profileId], ['class' => 'btn btn-outline-success mt-3']) ?>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card shadow py-3 px-4">
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-8">
                              <p class="normal-text"> <b> Location: </b> <br> <?= $model->location->location_name ?> </p>
                        </div>
                    </div>
