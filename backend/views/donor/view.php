        ...
        <div class="col-12 col-md-8">
            <div class="card shadow">
                <div class="card-body px-5 py-4">
                    ...
                    <p class="normal-text"><b> Email:</b><br> <?= $model->email ?></p>
                    <p class="normal-text"><b> Phone No:</b><br> <?= $profile->phoneNo ?> </p>
                    <?= Html::a(Yii::t('app', 'Update profile'), ['/donor/profile', 'id' => $model->id], ['class' => 'btn btn-outline-success mt-3']) ?>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card shadow py-3 px-4">
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-8">
                              <p class="normal-text"> <b> Role: </b> <br> <?= $model->role->role_name ?> </p>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-3">
                            <?php   
                                if($profile->gender->gender_id == 1){
                                    echo(Html::img('@web/../img/male.png',['class'=>'img-fluid mt-2']));
                                } elseif($profile->gender->gender_id = 2){
                        ...
                        <div class="col-8">
                              <p class="mt-2 normal-text"> <b> Gender: </b> <br> <?= $profile->gender->gender_name ?>
                              </p>
                        </div>
                    </div>
                    <div class="row mt-2">
                        ...
                        <div class="col-8">
                              <p class="normal-text"> <b> <?= $profile->level->level_name ?> </b> <br> 
                    ...
                    <div class="row mt-2">
                        <div class="col-3">
                            <?= Html::img('@web/../img/location.png',['class'=>'img-fluid']);?>
                        </div>
                        <div class="col-8">
                              <p class="normal-text"> <b> Location: </b> <br> <?= $profile->location->location_name ?> </p>
                        </div>
                    </div>
                    <div class="row mt-2 mb-3">
                        <div class="col-3">
                            <?php
                                if($profile->donor_eligibility == 1){
                    ...
                    <?= Html::a(Yii::t('app', 'Donation history'), ['/donor/donation-history', 'id' => $model->id], ['class' => 'btn btn-outline-success mt-3']) ?>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-8">
            <div class="card shadow">
                <div class="card-body px-5 py-4">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <?= Html::a(Yii::t('app', 'Update medical record'), ['/donor/medical-record','id' => $model->id], ['class' => 'btn btn-outline-success']) ?>
                        </div>
                    </div>
                </div>
